...
For FastGBS with DeepVariant, the input VCF file will be the merged and cleaned output 
from GLnexus (typically named FastGBS_deepvariant.vcf or as specified by OUTPLAT parameter)

The output file will be: out.GT.FORMAT
